    ...
    case request.method
      when :post
        ...
        if u
          ...
          AppMailer.deliver_alert("Login Alert","#{session['user']['name']} just logged on Scraper")
  ...
  def signup
	...
	@user.last_login = DateTime.now()
        ...
        if @user.save      
          ...
          AppMailer.deliver_alert("Registration Alert","#{session['user']['name']} just registered on Scaper")
